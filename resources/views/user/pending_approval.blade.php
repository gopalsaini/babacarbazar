		              ...
		              <table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
		                <thead>
		                  <tr>
							...
							<th>Category</th>
							<th>Name</th>
		                    <th data-sort-ignore="true">Post date</th>
		                    <th>Option</th>
		                  </tr>
		                </thead>
		                <tbody>
		                  ...
		                  <tr>
		                    ...
		                    <td style="width:15%" class="action-td">
		                      <div>
		                          ...
		                          <a class="btn btn-primary btn-sm" href="{{ url('posts/edit')}}/{{$product->id}}/{{$product->category_id}}">
		                            <i class="fa fa-edit"></i> Edit </a>
		                        
		                          <a class="btn btn-danger btn-sm delete-action" href="{{ url('post/delete')}}/{{$product->id}}">
