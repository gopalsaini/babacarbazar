...
@section('title',__('BabaMotord || Add Form'))
                ...
                <div class="panel panel-bd ">
                    ...
                    <div class="panel-body">
                        <div class="btn-group" id="buttonlist">
                            <a class="btn btn-add " href="{{ route('admin.products') }}" style="font-size: 11px;">
                ...
                <div class="panel panel-bd ">
                    <div class="panel-heading">
						@if(empty($category_id))
							<strong>SELECTED CATEGORY</strong><br><br><span>{{$name}}</span> <a href="{{route('admin.addproduct')}}" style="padding-left: 41px;font-weight: bold;">Change</a>
						@endif
					</div>
                    <div class="panel-body">
                        <form id="test" action="{{ route('admin.add-product')}}" method="post" enctype="multipart/form-data">
                            @csrf
							<div class="row">
								<div class="col-md-6">
									...
									@else
										<div class="form-group">
											...
											<select id="category" class="form-control custom-select select2" name="cate_id"
												required>
												<option value="">Select Category</option>
												@foreach($category as $cate)
													<option value="{{$cate->id}}" @if($cate->id == $category_id) selected @endif>{{$cate->cate_title}}</option>
												@endforeach
											</select>
										</div>
									@endif
									<div class="form-group">
										...
										<select id="brand" class="form-control custom-select select2" name="brand_id"
											required>
											<option value="">Select Brand</option>
											@foreach($brands as $brand)
												<option value="{{$brand->id}}" @if($brand->id == $brand_id) selected @endif>{{$brand->title}}</option>
											@endforeach
										</select>
									</div>
									<div class="form-group">
										<label for="model">Select Model <span style="color:red">*</span></label>
									...
									<div class="form-group">
										...
										<input required value="{{$year}}" type="tel" id="inputName" class="form-control" name="year"
											onkeypress="return /[0-9 ]/i.test(event.key)">
										
									</div>
									<div class="form-group">
										<label for="banner1">Fuel <span style="color:red">*</span></label><p></p>
										<input required type="radio" class="btn-check" id="btn-check" @if($fuel == 'CNG-Hybrids') checked @endif value="CNG-Hybrids" autocomplete="off" name="fuel"/>
										<label class="btn btn-primary" for="btn-check" style="font-size: 11px;">CNG & Hybrids</label>
										<input required type="radio" class="btn-check" id="btn-check2" @if($fuel == 'Diesel') checked @endif value="Diesel" autocomplete="off" name="fuel"/>
										<label class="btn btn-primary" for="btn-check2" style="font-size: 11px;">Diesel</label>
										<input required type="radio" class="btn-check" id="btn-check3" @if($fuel == 'Electric') checked @endif value="Electric" autocomplete="off" name="fuel"/>
										<label class="btn btn-primary" for="btn-check3" style="font-size: 11px;">Electric</label>
										<input required type="radio" class="btn-check" id="btn-check4" @if($fuel == 'LPG') checked @endif value="LPG" autocomplete="off" name="fuel"/>
										<label class="btn btn-primary" for="btn-check4" style="font-size: 11px;">LPG</label>
										<input required type="radio" class="btn-check" id="btn-check5" @if($fuel == 'Petrol') checked @endif value="Petrol" autocomplete="off" name="fuel"/>
										<label class="btn btn-primary" for="btn-check5" style="font-size: 11px;">Petrol</label>
										
									</div>
									<div class="form-group">
										<label for="banner1">Transmission <span style="color:red">*</span></label><p></p>
										<input required type="radio" class="btn-check" id="transmission1" @if($transmission == 'Automatic') checked @endif value="Automatic" autocomplete="off" name="transmission"/>
										<label class="btn btn-primary" for="transmission1" style="font-size: 11px;">Automatic</label>

										<input required type="radio" class="btn-check" id="transmission2" @if($transmission == 'Manual') checked @endif value="Manual" autocomplete="off" name="transmission"/>
										<label class="btn btn-primary" for="transmission2" style="font-size: 11px;">Manual</label>
										
									</div>
									<div class="form-group">
										<label for="km">KM driven <span style="color:red">*</span></label><p></p>
										<input maxlength="6" required type="tel" value="{{$km_drive}}" id="km"
                                            class="form-control" name="km_drive" onkeypress="return /[0-9 ]/i.test(event.key)">
									</div>
									<div class="form-group">
										<label for="banner1">No. of Owners <span style="color:red">*</span></label><p></p>
										<input required type="radio" class="btn-check" id="owners1" @if($owners == '1st') checked @endif value="1st" autocomplete="off" name="owners"/>
										<label class="btn btn-primary" for="owners1" style="font-size: 11px;">1st</label>

										<input required type="radio" class="btn-check" id="owners2" @if($owners == '2nd') checked @endif value="2nd" autocomplete="off" name="owners"/>
										<label class="btn btn-primary" for="owners2" style="font-size: 11px;">2nd</label>

										<input required type="radio" class="btn-check" id="owners3" @if($owners == '3rd') checked @endif value="3rd" autocomplete="off" name="owners"/>
										<label class="btn btn-primary" for="owners3" style="font-size: 11px;">3rd</label>
										<input required type="radio" class="btn-check" id="owners4" @if($owners == '4th') checked @endif value="4th" autocomplete="off" name="owners"/>
										<label class="btn btn-primary" for="owners4" style="font-size: 11px;">4th</label>
										<input required type="radio" class="btn-check" id="owners5" @if($owners == '4+') checked @endif value="4+" autocomplete="off" name="owners"/>
										<label class="btn btn-primary" for="owners5" style="font-size: 11px;">4+</label>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="banner1">UPLOAD UP TO 8 PHOTOS <span style="color:red">*</span></label>
										<div class="row mb-2">
											@if(!empty($images))
												@php $images = explode(',',$images);  @endphp 
													@foreach($images as $key=>$image)
														<div class="col-md-2 mb-2" id="data{{$key}}"> <span data-id="data{{$key}}" class="deleteimage" style="cursor: pointer;margin-left: 70px;border: 1px solid red;padding: 5px;border-radius: 50%;padding-top: -7px;">x</span>
									...
									<div class="form-group">
                                        ...
                                        <textarea required class="form-control summernote" rows="4"
                                            name="pro_desc" id="inputDescription">{{$pro_desc}}</textarea>
                                    </div>
									<div class="form-group">
										<label for="price">Price <span style="color:red">*</span></label><p></p>
										<input required type="tel" value="{{$price}}" id="price"
                                            class="form-control" name="price" onkeypress="return /[0-9 ]/i.test(event.key)">
									</div>
							...
							<br>
                            <div class="form-group">
                                <input type="submit" style="font-size: 15px;" id="inputProjectLeader" class="btn btn-success btn-xl" style="font-size: 11px;">
                            </div>
                        </form>
                    </div>
                </div>
