                ...
                <div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-3 offset-md-3">
							<div class="g-signin2 " data-longtitle="true" data-onsuccess="Google_signIn" data-theme="light" data-width="180"></div>

						</div>
						<div class="col-md-3 " style="margin-top: 10px;">
							<a href="javascript:void(0);" onclick="fbLogin()" id="fbLink" class="abcRioButton for-angkle " style="padding: 10px;"><i class="fab fa-facebook text-left" aria-hidden="true" ></i>  <span class="text-center">Sign in with Facebook</span></a>
