    ...
    t = {
        ...
        _initResumableUpload: function() {
            ...
            if (a.enableResumableUpload) {
                ...
                if (r.chunkSize = parseFloat(r.chunkSize), r.chunkSize <= 0 || isNaN(r.chunkSize)) return a._log(n.invalidChunkSize, {
                ...
                i = a.resumableManager = {
                    ...
                    sendAjax: function(e, l, s) {
                        var d, c = i.chunkSize,
                            ...
                            m = i.$btnDelete,
                            h = function(e, t) {
                                t && (e = e.setTokens(t)), e = g.resumableRequestError.setTokens({
                                    msg: e
                                }), a._log(e), s.reject(e)
                            };
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            if (l > r.maxRetries) return h(g.resumableMaxRetriesReached, {
                                n: r.maxRetries
                            ...
                            v = new FormData, d = o.stack[u], a._setUploadData(v, {
                                ...
                                t.error ? (r.showErrorLog && a._log(n.retryStatus, {
                                    ...
                                    filename: i.fileName,
                                    chunk: e
                                }), a._raise("filechunkerror", m), i.pushAjax(e, l + 1), i.error = t.error, h(t.error)) : (i.logs[t[f]] = !0, i.chunksProcessed[u] || (i.chunksProcessed[u] = {}), i.chunksProcessed[u][t[f]] = !0, i.chunksProcessed[u].data = t, s.resolve.call(null, t), a._raise("filechunksuccess", m), i.check())
                            }, C = function(t, r, n) {
                                return a._isAborted() ? void h(g.resumableAborting) : (w = a._getOutData(v, t), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, l, o, i, w]), i.pushAjax(e, l + 1), void h(g.resumableRetryError, {
                                    n: l - 1
                                }))
                            }, y = function() {
        ...
        _listen: function() {
            ...
            }), a._handler(r, "change", e.proxy(a._change, a)), a.showBrowse && (a._handler(a.$btnFile, "click", e.proxy(a._browse, a)), a._handler(a.$btnFile, "keypress", function(e) {
        ...
        _setZoomContent: function(i, a) {
            ...
            })), v.data("previewId", m), g._handler(v.find(".btn-kv-prev"), "click", function() {
        ...
        _showModal: function(e) {
            ...
            e && e.length && (t.initModal(a), t.setHtml(a, i._getModalContent()), i._setZoomContent(e), a.data({
                backdrop: !1
            }), console.log("KV--1"), a.modal("show"), console.log("KV--2"), i._initZoomButtons())
        },
        ...
        _uploadSingle: function(i, a, r) {
            ...
            w.enableResumableUpload || (w.showPreview && (o = b.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(F) || (v = function() {
            ...
            }, w._setFileData(C, P.file, k, a), w._setUploadData(C, {
                fileId: a
        ...
        _generatePreviewTemplate: function(i, a, r, n, o, l, s, d, c, u, p, f, g, m) {
            var h, v, w, b = this,
                ...
                S = E ? "other" : i;
            return v = 400 > x ? b.previewSettingsSmall[S] || b.defaults.previewSettingsSmall[S] : b.previewSettings[S] || b.defaults.previewSettings[S], v && e.each(v, function(e, t) {
                y += e + ":" + t + ";"
            }), w = function(a, s, d, u) {
                var m = d ? "zoom-" + o : o,
            ...
            }, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(I ? "other" : i, m ? m : a, !0, "kv-zoom-thumb")), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), h = w(E ? "other" : i, a, !1, "kv-preview-thumb"), h.setTokens({
                zoomCache: C
            })
        },
        ...
        _validateImageOrientation: function(i, a, r, n, o, l, s, d) {
            var c, u, p = this,
                f = null,
                g = p.autoOrientImage;
            return p.canOrientImage ? (i.css("image-orientation", g ? "from-image" : "none"), void p._validateImage(r, n, o, l, s, d, f)) : (u = t.getZoomSelector(r, " img"), f = g ? p._getExifObj(d) : null, (c = f ? f["0th"][piexif.ImageIFD.Orientation] : null) ? (p.setImageOrientation(i, e(u), c, p._getFrame(r)), p._raise("fileimageoriented", {
                $img: i,
                file: a
            }), void p._validateImage(r, n, o, l, s, d, f)) : void p._validateImage(r, n, o, l, s, d, f))
        },
        ...
        _getResizedImage: function(i, a, r, n) {
            ...
            try {
                P.drawImage(v, 0, 0, w, b), d = T.toDataURL(F, h.resizeQuality), S && (p = window.piexif.dump(S), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), h.fileManager.setFile(i, o), h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(h.msgImageResizeError, g, "fileimageresizeerror")
            } catch (A) {
        ...
        _setTabIndex: function(e, t) {
            ...
            return t.setTokens({
                tabIndexConfig: void 0 === a || null === a ? "" : 'tabindex="' + a + '"'
            })
        },
        ...
        _renderButton: function(e) {
            ...
            return a = i._setTabIndex(e, a), r += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", t.isEmpty(l) || (l = ' <span class="' + i.buttonLabelClass + '">' + l + "</span>"), a.setTokens({
                type: d,
                css: r,
                title: n,
                status: s,
            ...
            r.fileManager.clearImages(), e.each(i, function(e, t) {
                ...
                var y, x, T, P, F, k, E, I, S, A, D, z, j = i[w],
                    ...
                    V = function() {
                        ...
                        }, r.processDelay), r._raise("fileloaded", [j, M, U, w, n]) && r.isAjaxUpload ? e || C.add(j) : e && C.removeFile(U)
                    };
                if (j) {
                    if (I = C.getId(j), g > 0)
                    ...
                    if (t.isEmpty(m) || (O = new RegExp("\\.(" + m.join("|") + ")$", "i")), y = B.toFixed(2), r.isAjaxUpload && C.exists(I) || r._getFrame(M, !0).length) {
                        var q = {
                            id: M,
                            index: w,
                            fileId: I,
                        ...
                        return T = r.msgDuplicateFile.setTokens({
                            name: R,
                            size: y
                        }), void(r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [j, I, R, y, M, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(T, q), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                    }
                    ...
                    if (0 === N && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(O) && (F = t.compare(R, O), N += t.isEmpty(F) ? 0 : F.length, 0 === N)) return T = r.msgInvalidFileExtension.setTokens({
                        name: R,
                        extensions: h
                    }), void v(T, j, M, w, I);
                    if (!r._canPreview(j)) return S = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n]), r.isAjaxUpload && S && C.add(j), r.showPreview && S && (o.addClass("file-thumb-loading"), r._previewDefault(j), r._initFileActions()), void setTimeout(function() {
                        S && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [j, M, U, w])
                    }, 10);
                        ...
                        var a, s, d, c, u, f, g = [],
                            m = function() {
                                ...
                                e.onerror = function(e) {
                                    ...
                                    return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n]) ? (H = !0, r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable()) : (r._previewFile(w, j, e, L, s), r._initFileActions(), void V())
                                }, e.readAsDataURL(j)
                            };
                        if (s = {
                                name: R,
        ...
        cancel: function() {
            ...
            if (i.enableResumableUpload && o ? (o.cancel().done(function() {
                ...
                }), r.reset(), i._raise("fileuploadcancelled", [i.fileManager, r])) : i._raise("fileuploadcancelled", [i.fileManager]), i._initAjax(), l > 0)
        ...
        upload: function() {
            ...
            }), r.$preview.find(".file-preview-initial").removeClass(t.SORT_CSS), r._initSortable()), r._setProgress(2), r.hasInitData = !1, r.uploadAsync ? (i = 0, void e.each(r.getFileStack(), function(e) {
